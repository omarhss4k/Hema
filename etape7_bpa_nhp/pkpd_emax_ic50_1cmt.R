...
pkpd_emax_ic50_1cmt <- function(time, state, pars) {
  with(as.list(c(state, pars)), {
    ...
    # PK ADC 1-cmt (pas de C_ADC2)
    dC_ADC1 <- rate_in / V1_ADC - (CL_ADC/V1_ADC + k_int) * C_ADC1
    ...
    list(c(dC_ADC1, dC_DXd, dC_DXd_ic, dDamage,
           dMPP, dCMP, dMEP,
