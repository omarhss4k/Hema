...
DOSES<-c(0.1,0.3,0.5); SC_LAB<-"S1 (IC50_CMP=7.8 nM, ratio-Slope)"
...
ratio_MEP<-IC50_MEP_tdxd/155; ratio_CMP<-IC50_CMP_tdxd/7.8
...
pdf("results/BPA_v2_profiles_doses.pdf",width=16,height=9)
for (DOSE in DOSES) {
set.seed(42); N<-100
...
dev.off()
cat("-> results/BPA_v2_profiles_doses.pdf\n")
