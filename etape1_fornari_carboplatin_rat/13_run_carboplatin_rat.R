...
save_all_cells(
  ...
  file = "results/Figure3_simulation.pdf",
...
save_all_cells(
  sim = sim_f3, pars = init_pars,
  file = "results/Figure3_overlay.pdf",
...
grades_f3 <- save_grade_plots(
  sim = sim_f3, pars = init_pars,
  file = "results/Figure3_grades.pdf",
...
save_all_cells(
  ...
  file = "results/FigureS1_simulation.pdf",
...
grades_s1 <- save_grade_plots(
  sim = sim_s1, pars = init_pars,
  file = "results/FigureS1_grades.pdf",
