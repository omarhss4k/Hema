...
# L0 : taux de croissance exponentielle (régression log-linéaire, contrôle tronqué)
...
L1_init <- max(tv_ctrl[ok_ctrl_fit], na.rm = TRUE) * L0_init * 50
...
tc_test <- sim_ctrl_fn(L0_init, L1_init, tv0_ctrl, times_d[ok_ctrl_fit])
